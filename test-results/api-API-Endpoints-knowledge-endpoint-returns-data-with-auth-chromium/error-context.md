...
- Name: API Endpoints >> knowledge endpoint returns data with auth
- Location: /home/user/autoops/tests/e2e/api.spec.ts:95:7
...
Call log:
  - → GET http://localhost:3001/api/knowledge
    ...
    at /home/user/autoops/tests/e2e/api.spec.ts:99:36
```
