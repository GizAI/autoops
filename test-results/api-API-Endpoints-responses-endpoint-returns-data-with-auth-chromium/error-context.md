...
- Name: API Endpoints >> responses endpoint returns data with auth
- Location: /home/user/autoops/tests/e2e/api.spec.ts:73:7
...
Call log:
  - → GET http://localhost:3001/api/responses
    ...
    - Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNzQ1MjIwNjE2LCJleHAiOjE3NDUzMDcwMTZ9.7JTRZw4ESrcpoFVBkXo_o6BcU1wHCD3K-LamRKzRLfI

    at /home/user/autoops/tests/e2e/api.spec.ts:77:36
```
