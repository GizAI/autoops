...
Error: expect.toBeVisible: Error: strict mode violation: locator('h1') resolved to 2 elements:
    ...
    2) <h1 class="text-2xl font-bold text-gray-900">Knowledge Base</h1> aka getByRole('heading', { name: 'Knowledge Base', exact: true })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('h1')

    at /home/user/autoops/tests/e2e/dashboard.spec.ts:103:27
```
...
- main:
  ...
  - paragraph: Manage your knowledge base for email responses
  - button "Build from Emails"
  - heading "Search Knowledge Base" [level=3]
  - textbox "Enter search query..."
  - button "Search" [disabled]
  - heading "Knowledge Items" [level=3]
  - link "Add New Item":
    - /url: /dashboard/knowledge/new
  - paragraph: No knowledge items found. Click "Build from Emails" to generate knowledge items.
```
