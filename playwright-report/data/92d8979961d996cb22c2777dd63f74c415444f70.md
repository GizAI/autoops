...
- Name: Dashboard >> dashboard page loads correctly
- Location: /home/user/autoops/tests/e2e/dashboard.spec.ts:25:7
...
Call log:
  ...
  - waiting for locator('h1')
    ...
    at /home/user/autoops/tests/e2e/dashboard.spec.ts:28:27
```
