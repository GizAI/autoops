...
- Name: Dashboard >> navigation to emails page works
- Location: /home/user/autoops/tests/e2e/dashboard.spec.ts:46:7
...
Error: expect.toBeVisible: Error: strict mode violation: locator('h1') resolved to 2 elements:
    ...
    2) <h1 class="text-2xl font-bold text-gray-900">Emails</h1> aka getByRole('heading', { name: 'Emails' })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('h1')

    at /home/user/autoops/tests/e2e/dashboard.spec.ts:55:27
```
...
- button "Logout":
  ...
  - text: Logout
- main:
  - heading "Emails" [level=1]
  - paragraph: Manage your incoming emails
  - button "Sync Emails"
  - paragraph: No emails found. Sync to fetch new emails.
```
