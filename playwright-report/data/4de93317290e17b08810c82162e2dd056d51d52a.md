...
- Name: API Endpoints >> emails endpoint returns data with auth
- Location: /home/user/autoops/tests/e2e/api.spec.ts:51:7
...
Call log:
  - → GET http://localhost:3001/api/emails/processed
    ...
    at /home/user/autoops/tests/e2e/api.spec.ts:55:36
```
