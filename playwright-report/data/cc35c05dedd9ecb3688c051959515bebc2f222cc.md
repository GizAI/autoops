...
- Name: API Endpoints >> knowledge endpoint requires authentication
- Location: /home/user/autoops/tests/e2e/api.spec.ts:88:7
...
Call log:
  - → GET http://localhost:3001/api/knowledge
    ...
    at /home/user/autoops/tests/e2e/api.spec.ts:89:36
```
