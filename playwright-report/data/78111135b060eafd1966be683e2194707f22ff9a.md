...
- Name: API Endpoints >> responses endpoint requires authentication
- Location: /home/user/autoops/tests/e2e/api.spec.ts:66:7
...
Call log:
  - → GET http://localhost:3001/api/responses
    ...
    at /home/user/autoops/tests/e2e/api.spec.ts:67:36
```
